            ...
            <div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
                ...
                <div class="main_nav_container ml-auto">
                    <ul class="main_nav_list">
                        <li class="main_nav_item"><NavLink to="/">home</NavLink></li>
                        <li class="main_nav_item"><NavLink to="/about">about us</NavLink></li>
                        <li class="main_nav_item"><NavLink to="/offers">offers</NavLink></li>
                        <li class="main_nav_item"><NavLink to="/blogs">Blogs</NavLink></li>
                        <li class="main_nav_item"><NavLink to="/contact">contact</NavLink></li>
                    </ul>
                </div>
